...
///////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////
struct Indexer: public std::unary_function<const std::pair<GNode,unsigned>&, unsigned> {
   unsigned operator()(const std::pair<GNode,unsigned>& n) {
      return n.second;
   }
...
struct process {
   ...
   void operator()(const std::pair<GNode,unsigned>& srcn, ContextTy& lwl) {
      ...
      *MSTWeight.getLocal() += minEdgeWeight;
      ...
      lwl.push(std::make_pair(src, nEdge + nAdd));
#if COMPILE_STATISICS
...
///////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////
typedef Galois::InsertBag<std::pair<GNode,unsigned>> Bag;
...
struct InitialProcess {
  ...
  void operator()(GNode n) {
    bag.push(std::make_pair(n, Indexer::foo(n)));
  }
};
...
struct seq_gt: public std::binary_function<const std::pair<GNode,unsigned>&, const std::pair<GNode,unsigned>&, bool> {
   bool operator()(const std::pair<GNode,unsigned>& lhs, const std::pair<GNode,unsigned>& rhs) const {
...
EdgeDataType runBodyParallel() {
   ...
   typedef GlobPQ<WorkItem, LocalPQ<seq_gt, WorkItem, false>> LPQ;
